...
export default {
  data() {
    return {
      data:[
        { x: 'Argentina', y: 505370, r: '150' },
        { x: 'Belgium', y: 551500, r: '150' },
        { x: 'Cuba', y: 312685, r: '150.6' },
        { x: 'Dominican Republic', y: 350000, r: '145.5' },
        { x: 'Egypt', y: 301000, r: '150.8' },
        { x: 'Kazakhstan', y: 300000, r: '150.5' },
        { x: 'Somalia', y: 357022, r: '150.6' }
     ],
     radius: 'r',
